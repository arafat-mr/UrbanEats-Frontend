...
export default function Cart() {
  ...
  const fetchOrders = async () => {
    try {
      const res = await fetch("https://urban-eats-backend.vercel.app/orders/my-orders", {
        credentials: "include",
      });
  ...
  const handlePlaceOrder = async (order: Order) => {
    ...
    try {
      const res = await fetch(`https://urban-eats-backend.vercel.app/orders/place/${order.id}`, {
        method: "PATCH",
        credentials: "include",
  ...
  const handleCancelOrder = async (orderId: string) => {
    try {
      const res = await fetch(`https://urban-eats-backend.vercel.app/orders/cancel/${orderId}`, {
        method: "PATCH",
        credentials: "include",
      });
